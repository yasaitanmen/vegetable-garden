...
雨水タンクの重力差を利用し、4G携帯回線と広角カメラ・土壌水分/ECセンサーを統合した最新のシステム構成です。
...
【 システム全体構成図 】
  ...
  [ 自宅 屋外コンセント (AC100V) ]
                │
                ▼
  [ 12V 3A 防水ACアダプター ] （炎天下でも安心のバッテリーレス）
                │
    ┌───────────┴───────────┐
    │ (12V)                 │ (5V降圧)
    ▼                       ▼
【 給水バルブ系 】      【 制御・通信・カメラ系 (防水BOX) 】
・12V 電動ボールバルブ  ・4G LTE通信マイコン (SIM直挿し)
・バルブ開閉リレー      ・広角カメラ (ESP32-CAM)
                        ・土壌 水分・ECセンサー (水分＆肥料検知)
                                │
                                ▼ (4G 携帯回線)
                        【 夫婦2人のスマートフォン (Discord) 】
                        ・毎朝8時に「写真付き菜園レポート📸」が届く
                        ・肥料切れ時に「追肥アラート」通知
                        ・Googleスプレッドシート＆Driveに自動ログ保存
...
【 雨水重力給水の流れ 】
  ...
  [ 自宅の雨樋 ] ──► [ 雨水タンク (底上げ設置) ]
                     ...
                     [ 12V 電動ボールバルブ ] (ゼロ水圧対応)
                            ...
                            ▼
  ┌────────────────────────────────────────┐
  │ 6鉢の7ガロン不織布プランター (点滴給水) │
  └────────────────────────────────────────┘
```

### システムの3大特徴
1. **雨水重力給水 ＆ ゼロ水圧バルブ**: ポンプを使わず、底上げした雨水タンクの重力差と電動ボールバルブで無駄なく給水。水道代0円＆ゴミ詰まりなし。
2. **4G携帯回線 ＆ 写真付きDiscord通知**: 自宅Wi-Fiルーター不要。SIM直挿しマイコンで毎朝の写真と状態サマリーをDiscordへ自動送信。
3. **Googleログ ＆ 土壌水分/ECセンサー管理**: 水分低下で「自動給水」、肥料切れで「追肥アラート」を通知し、Google環境へ自動記録。
...
| **ガーデン対話コンパニオン** | 毎朝のDiscord画像送信、Googleスプレッドシート連携、追肥アラート通知 |
